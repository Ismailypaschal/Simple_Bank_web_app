...
@section('content')
    <div class="flex-1">
        <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-dark-500 dark:text-white">Good morning, Alex</h1>
                <p class="mt-1 text-base text-white">Here's your financial overview for today.</p>
            </div> --}}
            <!-- My Accounts -->
            <div class="rounded-xl border border-slate-200 bg-white p-4 sm:p-6 dark:border-slate-800 dark:bg-slate-900">
                <div class="flex flex-col items-center justify-center gap-4">
                    ...
                    <div class="flex flex-col gap-4">
                        <div>
                            <p class="text-3xl font-bold text-slate-900 dark:text-white" style="font-size: 30px">$25,843.50
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-6 lg:col-span-2">
                                ...
                                <li class="py-4">
                                    <div class="flex items-center space-x-4">
                                        ...
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate font-medium text-slate-900 dark:text-white">Amazon
                                                Marketplace</p>
                                            <p class="truncate text-sm text-slate-500 dark:text-slate-400">Oct 24, 2023</p>
                                        </div>
                                        <div class="text-right">
                                            <p class="font-semibold text-red-600">-$42.99</p>
                                            <p class="text-sm text-slate-500 dark:text-slate-400">Debit</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="py-4">
                                    <div class="flex items-center space-x-4">
                                        <div
                                            class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800">
                                            <span
                                                class="material-symbols-outlined text-slate-500 dark:text-slate-400">work</span>
                                        </div>
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate font-medium text-slate-900 dark:text-white">Direct Deposit -
                                                Acme Inc.</p>
                                            <p class="truncate text-sm text-slate-500 dark:text-slate-400">Oct 23, 2023</p>
                                        </div>
                                        <div class="text-right">
                                            <p class="font-semibold text-green-600">+$2,450.00</p>
                                            <p class="text-sm text-slate-500 dark:text-slate-400">Credit</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="py-4">
                                    <div class="flex items-center space-x-4">
                                        <div
                                            class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800">
                                            <span
                                                class="material-symbols-outlined text-slate-500 dark:text-slate-400">coffee</span>
                                        </div>
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate font-medium text-slate-900 dark:text-white">The Coffee Bean
                                            </p>
                                            <p class="truncate text-sm text-slate-500 dark:text-slate-400">Oct 22, 2023</p>
                                        </div>
                                        <div class="text-right">
                                            <p class="font-semibold text-red-600">-$5.75</p>
                                            <p class="text-sm text-slate-500 dark:text-slate-400">Debit</p>
                                        </div>
                                    </div>
                                </li>
                                <li class="py-4">
                                    <div class="flex items-center space-x-4">
                                        <div
                                            class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800">
                                            <span
                                                class="material-symbols-outlined text-slate-500 dark:text-slate-400">receipt_long</span>
                                        </div>
                                        <div class="min-w-0 flex-1">
                                            <p class="truncate font-medium text-slate-900 dark:text-white">Utility Bill
                                                Payment</p>
                                            <p class="truncate text-sm text-slate-500 dark:text-slate-400">Oct 21, 2023</p>
                                        </div>
                                        <div class="text-right">
                                            <p class="font-semibold text-red-600">-$112.30</p>
                                            <p class="text-sm text-slate-500 dark:text-slate-400">Debit</p>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <div class="relative w-full h-48 flex items-center justify-center my-4">
                            <svg class="w-full h-full" viewbox="0 0 36 36">
                                <path d="M18 2.0845
                                    ...
                                    stroke="#243347" stroke-width="3">
                                </path>
                                <path d="M18 2.0845
                                                               a 15.9155 15.9155 0 0 1 0 31.831" fill="none"
                                    stroke="#2a7aea" stroke-dasharray="75, 100" stroke-linecap="round" stroke-width="3">
                                </path>
                            </svg>
                    ...
                    <div
                        ...
                        <div class="mt-4 flex flex-col gap-4">
                            ...
                            <button class="mt-2 w-full h-10 rounded-lg bg-primary text-sm font-bold text-white">View Loan
                                Details</button>
                        </div>
                    </div>
                </div>
