                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="p-6 pb-0 mb-0">
                                    <h4 class="font-bold">Forgotten Password</h4>
                                ...
                                <div class="flex-auto p-6">
                                    <form role="form" method="POST" action="{{ route('password.email') }}">
                                        ...
                                        <div class="text-center">
                                            <button type="submit"
                                                class="inline-block w-full px-16 py-3.5 mt-6 mb-0 font-bold leading-normal text-center text-white align-middle transition-all bg-blue-500 border-0 rounded-lg cursor-pointer hover:-translate-y-px active:opacity-85 hover:shadow-xs text-sm ease-in tracking-tight-rem shadow-md bg-150 bg-x-25">Email
                                                Password Reset Link
                                            </button>
                                        </div>
                                    </form>
