    ...
    <aside
        ...
        <div class="flex flex-wrap justify-center -mx-3 mt-6">
            <div class="max-w-full px-3 flex-0">
                <div class="relative mx-auto -mt-16 w-16 h-16 ">
                    <!-- Profile Image -->
                ...
                <p class="dark:text-white mt-2 text-xl font-semibold">{{ $user->first_name }}
                    {{ $user->last_name }}</p>
                <p class="text-md leading-none text-center -mt-14">{{ $user->accounts->account_type }}</p>
            </div>
        </div>
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('user.dashboard') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('online_deposit') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        href="{{ route('online_deposit') }}">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 text-sm leading-normal text-orange-500 ni ni-calendar-grid-58"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Online Deposit</span>
                    </a>
                </li>

                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('domestic_transfer') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        href="{{ route('domestic_transfer') }}">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 text-sm leading-normal text-orange-500 ni ni-calendar-grid-58"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Domestic Transfer</span>
                    </a>
                </li>

                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('wire_transfer') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        href="{{ route('wire_transfer') }}">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 text-sm leading-normal text-orange-500 ni ni-calendar-grid-58"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Wire Transfer</span>
                    </a>
                </li>

                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('virtual_card') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        href="../pages/profile.html">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 text-sm leading-normal text-slate-700 ni ni-single-02"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Account Manager</span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('credit_debit') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        href="{{ route('credit_debit') }}">
                        <div
                            class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                            <i class="relative top-0 text-sm leading-normal text-slate-700 ni ni-single-02"></i>
                        </div>
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Credit / Debit Transaction
                        </span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('wire') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Wire Transaction </span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('domestic') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Domestic Transaction
                        </span>
                    </a>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class="{{ request()->routeIs('loan_transaction') ? 'bg-blue-500/13 font-semibold text-slate-700' : ' ' }} dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Loan Transaction </span>
                    </a>
                </li>

                <li class="w-full mt-4">
                    <h6 class="pl-6 ml-2 text-xs font-bold leading-tight uppercase dark:text-white opacity-60">Settings
                    </h6>
                </li>
                ...
                <li class="mt-0.5 w-full">
                    <a class=" dark:text-white dark:opacity-80 py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Account</span>
                    </a>
                </li>
            ...
            <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border"
                ...
                <div class="flex-auto w-full p-4 pt-0 text-center">
                    <div class="transition-all duration-200 ease-nav-brand">
                        ...
                        <p class="mb-0 text-xs font-semibold leading-tight dark:text-white dark:opacity-60">Please
                            check
                            our docs</p>
                    </div>
                </div>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                            ...
                            @elseif(request()->routeIs('profile'))
                                Profile
                            @elseif(request()->routeIs('edit.profile'))
                                Edit profile
